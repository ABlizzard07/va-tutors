            ...
            <div className="bg-blue-300 h-84 flex justify-center items-center">
                <div className="text-center p-10 max-w-7xl">
                    ...
                    <p className="mt-4 text-lg text-center">
                        ...
                        Our classes are online by default, but if you want in-person tutoring, contact us and we will try to arrange that.
                    </p>
            ...
            <div className="flex flex-col items-center py-8 bg-blue-200">
                <div className="max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 p-10">
                    <div>
                        ...
                        <p className="text-lg mb-4">
                            We have also partnered with an LLM platform, Skylow, that allows users to instantly communicate with students from their dream schools. While you wait to be paired with one of our college application advisors, Skylow has free and premium features that will propel you in your application journey.
                        </p>
